...
#if _DEBUG
ParticleEffect g_ParticleEffect(5000);
#else
...
int main( int argc, char* argv[] )
{
    ...
    if ( g_ParticleEffect.LoadTexture( "Data/Textures/square.png" ) )
    {
    ...
    colors.AddValue(0.0f, glm::vec4(1,     1, 0, 0.5f));   // yellow
	colors.AddValue(0.1f, glm::vec4(1, 0.65f, 0, 0.5f));   // orange
    colors.AddValue(1.0f, glm::vec4(1,     0, 0, 0.5f));   // red
